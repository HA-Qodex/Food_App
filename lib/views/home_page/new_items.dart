...
class NewItems extends StatelessWidget {
  ...
  NewItems({Key key, @required this.index}) : super(key: key);
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            image: DecorationImage(
                              image: NetworkImage(controller.newList[index].image),
                              fit: BoxFit.cover,
                            ),
                                ...
                                child: Align(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Text(controller.newList[index].time,
                                          style: TextStyle(
                                              fontSize: 15,
                            ...
                            Positioned(
                                ...
                                child: CircleAvatar(
                                  ...
                                  child:GestureDetector(
                                            onTap: () {
                                              controller
                                                  .wishItems(controller.newList[index]);
                                            },
                                            child: controller.wishList.contains(controller.newList[index])
                                                ? Icon(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: CircleAvatar(
                            ...
                            radius: 15,
                            child: Text("\$${controller.newList[index].price}",
                                style: TextStyle(
                                    fontSize: 13,
                                    fontWeight: FontWeight.w900,
                                    color: Colors.white)),
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Text(controller.newList[index].rating,
                                style: TextStyle(
                                    fontSize: 15,
                                    fontWeight: FontWeight.w900,
                                    color: Colors.black)),
                        ...
                        Row(
                          children: [
                            ...
                            Text(controller.newList[index].test,
                                style: TextStyle(
                                    fontSize: 15,
                                    fontWeight: FontWeight.w900,
                                    color: Colors.black)),
                        ...
                        Row(
                          children: [
                            ...
                            Text(controller.newList[index].category,
                                style: TextStyle(
                                    fontSize: 15,
                                    fontWeight: FontWeight.w900,
                                    color: Colors.black)),
            ...
            child: Column(
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Container(
                      child: Image.network(
                        controller.newList[index].image,
                        fit: BoxFit.cover,
                      )),
                ),
                SizedBox(height: 15,),
                    ...
                    ElevatedButton(
                        style: ElevatedButton.styleFrom(
                            ...
                            shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(10))),
                        onPressed: () {
                          controller.wishItems(controller.newList[index]);
                        },
                        child: Text(
                          "Add to wishlist",
                          style: TextStyle(
